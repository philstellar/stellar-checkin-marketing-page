        ...
        <div className="container-custom">
          <Card className="bg-white shadow-sm border-0">
            <CardContent className="p-8 md:p-12">
              <h1 className="text-3xl md:text-4xl font-bold mb-8 text-stellar-700">Impressum</h1>
              
              <div className="space-y-8">
                <section className="space-y-4">
                  <h2 className="text-xl md:text-2xl font-semibold text-stellar-600">Angaben gemäß § 5 TMG</h2>
                ...
                <section className="space-y-4">
                  <h2 className="text-xl md:text-2xl font-semibold text-stellar-600">Handelsregister</h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <section className="space-y-4">
                  <h2 className="text-xl md:text-2xl font-semibold text-stellar-600">Vertreten durch</h2>
                ...
                <section className="space-y-4">
                  <h2 className="text-xl md:text-2xl font-semibold text-stellar-600">Kontakt</h2>
                  <p className="text-gray-700 leading-relaxed">
                    E-Mail: <a href="mailto:philipp@stellar-trust.com" className="text-primary hover:underline font-medium">philipp@stellar-trust.com</a>
                  </p>
                </section>
                ...
                <section className="space-y-4">
                  <h2 className="text-xl md:text-2xl font-semibold text-stellar-600">Umsatzsteuer-Identifikationsnummer</h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <section className="space-y-4">
                  <h2 className="text-xl md:text-2xl font-semibold text-stellar-600">Verantwortliche Person für die Redaktion</h2>
                  <p className="text-gray-700 leading-relaxed">Philipp Reuter</p>
                </section>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="versicherungsvermittlung" className="border-none">
                    <AccordionTrigger className="text-xl md:text-2xl font-semibold text-stellar-600 py-2 hover:no-underline hover:text-primary">
                    ...
                    <AccordionContent>
                      <div className="space-y-4 text-gray-700 leading-relaxed pl-2">
                        ...
                        <p>
                          <a href="https://www.vermittlerregister.info" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">www.vermittlerregister.info</a>
                        </p>
                ...
                <section className="space-y-4">
                  <h2 className="text-xl md:text-2xl font-semibold text-stellar-600">Beschwerden</h2>
                  <p className="text-gray-700 leading-relaxed">
                    Bei Beschwerden über unsere Tätigkeit wende dich gerne an unsere Beschwerdestelle:<br />
                    E-Mail: <a href="mailto:complaint@stellar-trust.com" className="text-primary hover:underline font-medium">complaint@stellar-trust.com</a>
                  </p>
                ...
                <section className="space-y-4">
                  <h2 className="text-xl md:text-2xl font-semibold text-stellar-600">Haftungshinweis</h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <section className="space-y-4">
                  <h2 className="text-xl md:text-2xl font-semibold text-stellar-600">EU-Streitbeilegung</h2>
                  <p className="text-gray-700 leading-relaxed">
                    Die Europäische Kommission stellt eine Plattform für die Online-Streitbeilegung (OS) zur Verfügung: <a href="https://ec.europa.eu/consumers/odr/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">https://ec.europa.eu/consumers/odr/</a>.<br />
                ...
                <section className="space-y-4">
                  <h2 className="text-xl md:text-2xl font-semibold text-stellar-600">Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle</h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <section className="space-y-4">
                  <h2 className="text-xl md:text-2xl font-semibold text-stellar-600">Zentrale Kontaktstelle nach dem Gesetz über digitale Dienste – DSA (Verordnung (EU) 2022/265)</h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    <a href="https://www.lau.do" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">www.lau.do</a>
                  </p>
                </section>
              </div>
