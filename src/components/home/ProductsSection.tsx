...
const ProductsSection = () => {
  ...
  return <section className="py-16 bg-white relative overflow-hidden">
      <div className="container-custom">
        <HeadingWithLine title="Unsere Produkte" subtitle="Entdecken Sie unsere Lösungen für eine optimale Gästeverwaltung und mehr Vertrauen in Ihrer Ferienunterkunft." align="center" />
        
        <div className="grid md:grid-cols-3 gap-8">
          {products.map((product, index) => <Card key={index} className="h-full border border-gray-200 bg-white">
              ...
              <CardContent className="pt-4">
                ...
                <Button variant="outline" onClick={() => navigate(product.path)} className="w-full justify-center font-aeonik">
