  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        isMobile && "appearance-none", // Add native-like styling for mobile
        className
      )}
      {...props}
    >
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          isMobile && "bg-white text-black", // Enhanced contrast for mobile
          className
        )}
        position={position}
        {...props}
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        isMobile && "py-3 text-base", // Larger touch targets for mobile
        className
      )}
      {...props}
    >
