    ...
    <section id="einstellungen" className="py-20 bg-gray-50">
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-royal-700 max-w-2xl mx-auto break-words">
            {t('settings.subtitle')}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {features.map((feature, index) => (
            <Card 
              key={index} 
              className="h-full transition-all duration-300 hover:shadow-lg border border-gray-200 bg-white flex flex-col"
            >
              <CardHeader className="pb-4 flex flex-col items-center text-center">
                ...
                <CardTitle className="text-lg font-semibold text-royal break-words">
                  {feature.title}
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-2 text-center flex-grow">
                <p className="text-royal-700 break-words">{feature.description}</p>
              </CardContent>
            </Card>
          ))}
        </div>
