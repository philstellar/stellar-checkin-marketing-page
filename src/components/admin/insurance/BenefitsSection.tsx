...
const BenefitsSection = () => {
  ...
  const benefits = [
    {
      icon: <CalendarCheck className="h-6 w-6 text-royal" />,
      title: t('insurance.benefits.list.0')
    },
    {
      icon: <Percent className="h-6 w-6 text-royal" />,
      title: t('insurance.benefits.list.1')
    },
    {
      icon: <Plus className="h-6 w-6 text-royal" />,
      title: t('insurance.benefits.list.2')
    },
    {
      icon: <LinkIcon className="h-6 w-6 text-royal" />,
      title: t('insurance.benefits.list.3')
    },
    {
      icon: <ShieldCheck className="h-6 w-6 text-royal" />,
      title: t('insurance.benefits.list.4')
    },
    {
      icon: <FileCheck className="h-6 w-6 text-royal" />,
