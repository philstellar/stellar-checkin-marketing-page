...
export const identityEN = {
  ...
  verification: {
    ...
    steps: "Simple three-step process",
    secure: "Secure and compliant",
    fast: "Fast results within minutes"
  },
  benefits: {
    title: "Benefits",
    security: "Enhanced security and trust",
    compliance: "Regulatory compliance",
    automation: "Automated verification without manual checks"
  },
  features: {
    title: "Key Features",
    biometric: {
