...
export const pricingEN = {
  ...
  basic: {
    ...
    insuranceDesc: "Insurance is optional for the guest or can be chosen as an alternative to the deposit.",
    digitalGuestRegistration: "Guest Registration with Authorities",
    ...
    features: [
      ...
      "Deposit Management",
      "Guest Insurance",
      "Accommodation Agreement Acceptance"
    ]
  },
  advanced: {
    title: "Advanced",
