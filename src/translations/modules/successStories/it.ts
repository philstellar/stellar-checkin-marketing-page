...
export const successStoriesIT = {
  title: "Le nostre <span>Storie di Successo</span>",
  subtitle: "Scopri come proprietari e host utilizzano Stellar Checkin per ottimizzare i processi e aumentare il proprio successo.",
  cta: "Registrati ora",
  clientsTitle: "Clienti selezionati",
